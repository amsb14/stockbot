...
def insert_stock_info(rows):
    ...
    INSERT INTO stock_data (
        ...
        "fiveYearAvgDividendYield", "trailingPE",
        "enterpriseValue", "enterpriseToEbitda", "payoutRatio",
        "freeCashflow", "operatingCashflow", "earningsGrowth",
        "revenueGrowth", "grossMargins", "beta", "heldPercentInsiders",
        "trailingEps", "forwardEps", "epsCurrentYear",
        "volume", "marketCap", "fiftyTwoWeekLow", "fiftyTwoWeekHigh",
        "fiftyDayAverage", "twoHundredDayAverage", "sharesOutstanding",
        "bookValue", "priceToBook", "lastDividendValue",
        "lastDividendDate", "recommendationKey", "totalCash",
        "ebitda", "totalDebt", "currentRatio", "totalRevenue",
        "returnOnAssets", "returnOnEquity", "financialCurrency",
        "marketState", "averageDailyVolume3Month",
    ...
    ON CONFLICT (symbol) DO UPDATE SET
        ...
        "epsCurrentYear" = EXCLUDED."epsCurrentYear",
